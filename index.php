    ...
    <body>
            ...
            <header>
                <div class="nav_bar_top">
                    <img src="https://cdn.pixabay.com/photo/2015/10/31/12/54/google-1015751_1280.png" alt="logo_google">
            ...
            <main>
                <ul class="main_content">
                    <?php foreach ($faq as $risposta) {?>
                        <li> <h3 class="question"> <?php echo $risposta['question']; ?></h3> <br> <p class="answer"><?php echo $risposta['answer'];?> </p> </li>
                    <?php } ?>
                </ul>
            </main>
